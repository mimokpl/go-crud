module github.com/mimokpl/go-crud/entgo
...
replace github.com/mimokpl/go-crud/audit => ../audit

replace github.com/mimokpl/go-crud/viewer => ../viewer

replace github.com/mimokpl/go-crud/cache => ../cache
...
require (
	...
	github.com/mimokpl/go-crud/audit v0.0.3
